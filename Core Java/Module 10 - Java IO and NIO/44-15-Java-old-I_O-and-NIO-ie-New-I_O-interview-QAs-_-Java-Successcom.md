# 44. 15 Java old I O and NIO ie New I O interview Q&As   Java Successcom
...
2) More efficient r eads and writes in terms of blocks of data using buf fers as opposed to reading or writing in byte streams. Lar ge files can be created and
