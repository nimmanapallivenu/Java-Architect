# 50. Java 7 features list   Java Successcom
...
} catch (IllegalAr gumentException e) {
 System .out.println ("Color not found" );
}
...
public static void main (String [] args) {
 //Pre Java 7
getEmployeesW ithManagersOld ("a102" );
//Java 7
getEmployeesW ithManagersNew ("a102" );
public static Map<String , List<Employee >> getEmployeesW ithManagersOld (String empCode ){
 if(empCode == null){
...
Another very handy feature is the WatchService for file change notifications. It can monitor a directory for changes as demonstrated below . }
 ...
 return mapEmployees ;
/Java 7
public static Map<String , List<Employee >> getEmployeesW ithManagersNew (String empCode ){
 if(empCode == null){
 return Collections .emptyMap ();
 }
