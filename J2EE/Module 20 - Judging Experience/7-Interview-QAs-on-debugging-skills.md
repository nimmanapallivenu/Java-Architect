# 7 Interview Q&As on debugging skills
...
XX:+HeapDumpOnOutOfMemoryErr or. You could also dump the heap on ctrl+brk key stroke by setting the JVM ar gument -
...
#3. Memory is cheap and abundant on modern servers, but garbage collector pauses is a serious obstacle for using lar ger memory sizes. You should configure
...
library? How often do you see exceptions like NoSuchMethodErr or or IllegalAr gumentException . Here are some tips to solve the JAR hell problem.
