# Bean Validation & Async Processing

> **Module**: JEE Overview  
> **Topic**: Bean Validation & Async Processing
...
@Documented
@Target({ElementT ype.METHOD, ElementT ype.FIELD, ElementT ype.annotation_TYPE })
@Retention (RUNTIME )
...
The URL newPage.html will be refreshed every 10 seconds. This approach has the downside of wasting network bandwidth and server resources. With the
...
web.xml file, making it large and dif ficult to isolate framework specific descriptors. The Servlet 3.0 specification addresses this issue by introducing web
