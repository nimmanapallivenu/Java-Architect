# JEE Platform Overview

> **Module**: JEE Overview  
> **Topic**: JEE Platform Overview
...
- [Q8: What is the difference between a W eb server and an application server?](#q8)
...
Content Delivery Networks), which is a large distributed system of servers deployed in multiple data centers across the Internet. The goal of a CDN is to serve
...
## Q8: What is the difference between a W eb server and an application server?
...
The key difference between the EJB and W AR class loader is that all the EJB jars in the application share the same EJB class loader whereas W AR files get their
