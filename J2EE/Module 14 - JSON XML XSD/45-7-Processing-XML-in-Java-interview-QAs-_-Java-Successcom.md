# 45 7 Processing XML in Java interview Q&As   Java Success.com
...
navigated and parsed arbitrarily , providing the maximum flexibility for developers. However this flexibility comes at a cost of lar ge memory footprint and
...
This may not be an issue when working with small documents, but memory and processor requirements can escalate quickly for lar ger size documents.
