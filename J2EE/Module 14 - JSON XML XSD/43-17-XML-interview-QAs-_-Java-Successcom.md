# 43 17 XML interview Q&As   Java Success.com
...
amounts of data like configuration files (web.xml, application.xml, struts-config.xml, etc) to lar ge company wide data with the help of XML stored in the
database.
...
XML is verbose and it can be 4-6 times lar ger in size compared JSON or csv data. If your network lacked bandwidth and/or your content is too lar ge and
