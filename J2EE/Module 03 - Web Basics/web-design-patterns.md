...
a problem for web designers when you have large amount of Java code in your JSP pages. In many cases, the page receiving the request is not the page, which
