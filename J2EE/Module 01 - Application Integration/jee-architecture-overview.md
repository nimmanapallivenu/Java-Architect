...
> **Topic**: JEE Architecture Overview
...
proportions) or scale down dynamically based on demand. This implies a very large pool of computing resources either be within the enterprise intranet or on the Internet
(i.e on the cloud).
...
A. Microservices allow large systems to be built from a number of collaborating components. The collaborating components can be web services, messaging, event-
