# 59. 12 Java design patterns interview Q&As   Java Successcom
...
creating a large number of objects, we reuse the objects that are already created. W ith fewer objects, your application could fly . public static class Builder
 {
...
public class StartsW ithCD implements CheckStrategy {
...
Decoratorpublic boolean check (String description ) {
 ...
 return s.startsW ith(STARTS_WITH );
}
