# 14. 3 Java class loading interview Q&As to ascertain your depth of Java knowledge   Java Successcom
...
5) -verbose:class option in your JVM. W ith the -verbose option all the classes that are loaded are listed, along with the JAR file or directory from which they
