# 12 Java OOPs interview questions & answers with lots of diagrams
...
- [Q10: What is the dif ference between OOP & Functional Programming (i.e. FP)?](#q10)
...
I would say Java is not 100% object oriented, but it embodies practical OO concepts. Strictly speaking not 100% object orieneted due to:
...
3) not supporting multiple class inheritance to solve the diamond problem because dif ferent classes may have dif ferent variables with same name that may be
...
Both abstraction and encapsulation solve same problem of complexity in dif ferent dimensions. Encapsulation exposes only the r equir ed details of an
...
can easily incorporate new types of cars at runtime by creating a new car object with the relevant “make” and “model” as ar guments as opposed to having to
...
Q. What is the dif ference between Abstraction & Generalization?
...
objects at runtime with dif ferent employmentT ypes.
...
All these 3 lead to “ best practices ” for building a quality application with Java classes & interfaces, which are the building blocks. Y ou can’ t use these
...
## Q10: What is the dif ference between OOP & Functional Programming (i.e. FP)?
...
other and you can use both in your next Java application if using Java 8. Y ou like it or not, you will be using functional programming in Java, and interviewers
