# 1149 JNDI and LDAP interview Q&A   Java Success.com
...
So in a nutshell, LDAP is more useful when the information is often searched but rarely modified. (Another dif ference is that RDBMS systems store
...
InitialDirContext object that takes a Hashtable as an ar gument:
...
/finding local enterprise beans within the same module.
