# 31 12 JDBC basics interview Q&As   Java Success.com

## Table of Contents

- [Q1: What are JDBC Statements? What are dif ferent types of statements? How can you c](#q1)
- [Q2: What is the dif ference between statements and prepared statements? Which one wo](#q2)
...
- [Q9: What is RowSet ? What is the dif ference between RowSet and ResultSet ? What are](#q9)
...
## Q2: What is the dif ference between statements and prepared statements? Which one would you favor and why?

**Answer:**

#1. Pr epar ed statements offer better performance , as they are pre-compiled. Prepared statements reuse the same execution plan for dif ferent ar guments rather
than creating a new execution plan every time. Prepared statements use bind ar guments, which are sent to the database engine. This allows mapping dif ferent
requests with same prepared statement but dif ferent ar guments to execute the same execution plan.
...
## Q9: What is RowSet ? What is the dif ference between RowSet and ResultSet ? What are the advantages of using RowSet over ResultSet?
...
nothing” types of events — start a transaction, insert some rows, do some updates, and then either commit or rollback. W ith JDBC 3.0, the transactional model
