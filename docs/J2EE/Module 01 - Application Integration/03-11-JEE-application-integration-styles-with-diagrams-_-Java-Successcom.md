# 3 11 JEE application integration styles with diagrams   Java Success.com
...
2. batch file transfer . E.g ETL (i.e. Extract Transform & Load), and ELT in BigData & data lakes where lar ge quantities of data is first loaded and then
transformed.
...
graphical user inteface for routing and configuring, etc. Usually , an ESB is a complex and powerful product with a higher learning curve. Suited for very lar ge
...
1) Event-driven concurrency: E.g. RxJava. This is based on events, which are monitored by zero or more observers. The big dif ference between event-driven
...
even pass messages to them selves. Apache Spark is a fast and general execution engine for lar ge-scale data developed on the “ Actor Model “. Scala Async
