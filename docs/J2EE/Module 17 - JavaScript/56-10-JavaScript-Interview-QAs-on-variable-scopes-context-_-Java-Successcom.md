# 56 10 JavaScript Interview Q&As on variable scopes & context   Java Success.com
...
- [Q6: What is the dif ference between the .call(….) and .apply(…) methods?](#q6)
- [Q7: What is the dif ference between undefined and null?](#q7)
- [Q8: What is the dif ference between “==” and “==” in JavaScript?](#q8)
...
An alternative approach to calling a function is with the the “call(object)” method. It takes the object to call the function on as an ar gument.
...
## Q6: What is the dif ference between the .call(….) and .apply(…) methods?

**Answer:**

The dif ference is that apply(argArray) lets you invoke the function with ar guments as an array whereas call(arg1, arg2, arg3) requires the parameters be listed explicitly .
...
## Q7: What is the dif ference between undefined and null?
...
## Q8: What is the dif ference between “==” and “==” in JavaScript?
