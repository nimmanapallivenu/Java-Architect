# 36 5 JMX and MBean interview Q&As   Java Success.com
...
remote Java V irtual Machine (JVM).
...
to W eb-based GUI (HTML/HTTP , WML/HTTP , …).
...
MBean server .
Whilst the server is running, you can connect to it using jconsole. Y ou can interact with operations and attributes via the jconsole GUI. This is demonstrated
...
JMX allows us to monitor local or remote applications. W e can use it to detect memory and thread usage, and generate heap dumps.
