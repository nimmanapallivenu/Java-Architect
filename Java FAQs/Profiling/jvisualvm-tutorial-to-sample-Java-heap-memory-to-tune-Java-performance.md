# jvisualvm tutorial to sample Java heap memory to tune Java performance
...
Double click on “ ObjectSize with pid 1208.” Y ou will get the following screen, and select the “Sampler” tab.
jvisualvm sampler
